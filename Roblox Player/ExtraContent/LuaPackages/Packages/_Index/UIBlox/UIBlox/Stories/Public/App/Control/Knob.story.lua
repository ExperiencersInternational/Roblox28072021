...
function KnobOverviewComponent:render()
	if UIBloxConfig.enableExperimentalGamepadSupport then
		...
		return Roact.createElement("Frame", {
			...
			KnobA = Roact.createElement(AppStyleProvider, {
				style = {
					themeName = LIGHT_THEME,
					fontName = DEFAULT_FONT,
				},
			...
			KnobB = Roact.createElement(AppStyleProvider, {
				style = {
					themeName = LIGHT_THEME,
					fontName = DEFAULT_FONT,
				},
			...
			KnobC = Roact.createElement(AppStyleProvider, {
				style = {
					themeName = LIGHT_THEME,
					fontName = DEFAULT_FONT,
				},
			...
			KnobD = Roact.createElement(AppStyleProvider, {
				style = {
					themeName = DARK_THEME,
					fontName = DEFAULT_FONT,
				},
			...
			KnobE = Roact.createElement(AppStyleProvider, {
				style = {
					themeName = DARK_THEME,
					fontName = DEFAULT_FONT,
				},
