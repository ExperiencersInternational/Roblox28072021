...
local UIBloxConfig = require(Packages.UIBloxResources.UIBloxStorybookConfig)
...
function BaseMenuOverviewComponent:render()
	...
	local frameComponent = UIBloxConfig.enableExperimentalGamepadSupport
	and RoactGamepad.Focusable.Frame
		or "Frame"
	...
	return Roact.createElement("ScrollingFrame", {
		...
		InputManager = UIBloxConfig.enableExperimentalGamepadSupport
			and RoactGamepad.withFocusController(function(focusController)
		...
		Oneitem = Roact.createElement(StoryItem, {
			...
			OneItemFrame = Roact.createElement(frameComponent, {
		...
		ThreeItems = Roact.createElement(StoryItem, {
			...
			ThreeItemsFrame = Roact.createElement(frameComponent, {
				Size = UDim2.new(1, 0, 1, 0),
				BackgroundTransparency = 1,
		...
		NineItems = Roact.createElement(StoryItem, {
			...
			NineItemsFrame = Roact.createElement(frameComponent, {
				Size = UDim2.new(1, 0, 1, 0),
				BackgroundTransparency = 1,
...
local function wrapStoryForGamepad(story)
	...
	return Roact.createElement(FocusContainer, {}, {
		InputManager = UIBloxConfig.emptyStateControllerSupport
			and RoactGamepad.withFocusController(function(focusController)
			return Roact.createElement(InputManager, {
				focusController = focusController,
			})
