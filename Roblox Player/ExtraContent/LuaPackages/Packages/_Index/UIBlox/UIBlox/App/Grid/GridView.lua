...
function GridView:render()
	...
	return Roact.createElement(UIBloxConfig.enableExperimentalGamepadSupport and
		...
		[Roact.Ref] = UIBloxConfig.enableExperimentalGamepadSupport and self.props.frameRef or self.frameRef,
...
function GridView:didMount()
	...
	local ref = UIBloxConfig.enableExperimentalGamepadSupport and self.props.frameRef or self.frameRef
...
return Roact.forwardRef(function (props, ref)
	return Roact.createElement(GridView, Cryo.Dictionary.join(
		props,
		{frameRef = ref}
	))
end)