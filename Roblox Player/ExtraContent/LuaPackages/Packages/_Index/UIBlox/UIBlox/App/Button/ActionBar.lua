...
function ActionBar:render()
	...
	return withStyle(function(stylePalette)
		...
		local fitFrameOnAxisComponent = UIBloxConfig.enableExperimentalGamepadSupport and
			RoactGamepad.Focusable[FitFrameOnAxis] or FitFrameOnAxis
		return Roact.createElement(fitFrameOnAxisComponent, {
			BackgroundTransparency = 1,
...
return Roact.forwardRef(function(props, ref)
	return Roact.createElement(ActionBar, Cryo.Dictionary.join(props, {
		frameRef=ref
	}))
end)